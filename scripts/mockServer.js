...
const { MockDataGenerator } = require('./generateMockData');

const PORT = process.env.PORT || 4000;
const generator = new MockDataGenerator(108);

console.log('⚡ Initializing high-performance deterministic datasets...');
...
console.log(`✅ Loaded: 5,000 Doctors | 20,000 Products | 10,000 Health Records`);
...
const server = http.createServer(async (req, res) => {
  ...
  if (pathname === '/health' || pathname === '/') {
    return sendJSON(res, 200, {
      status: 'UP',
      app: 'Amrutam Ayurvedic Super App Mock API',
      datasets: {
...
server.listen(PORT, '0.0.0.0', () => {
  console.log(`====================================================`);
  console.log(`🌿 Amrutam Ayurvedic Mock REST API is running!`);
  console.log(`🚀 URL: http://localhost:${PORT}`);
  console.log(`📱 LAN: http://10.13.22.227:${PORT} (Accessible by Android device)`);
  console.log(`====================================================`);
});
